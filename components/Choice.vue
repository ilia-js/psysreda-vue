  ...
  <div class="col-12 b-even">
    <div>
      ...
      <div class="d-block mx-auto col-md-6 text-center">
        <div>
          <h2 class="t-6 text-left">Отношения жертва-спасатель-агрессор</h2>
          <p class="text-left">
        ...
        <div>
          <h2 class="t-6 text-left">Жизнь состоит из ожиданий и откладывания на потом</h2>
          <p class="text-left">
        ...
        <div>
          <h2 class="t-6 text-left">Твоей жизнью распоряжается кто угодно, только не ты</h2>
          <p class="text-left">
