    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
					<div id="gotest">
						<div class="zagolovok">Тест на созависимость</div>
						<div class="opisanie">
							Вам предлагается 20 утверждений, которые нужно оценить применительно к себе.
							<br/>Отвечайте, не думая слишком долго над каждым утверждением, обычно первый ответ, который приходит в голову, является самым точным.
						</div>
						<div>
							<ol class="test" v-for="(question, index) in questions" type="1" style="list-style-type:none;padding-left:15px;">
								<li>{{ index+1 }}. {{ question.content }}
								<br/>
						...
						<div id="show_answer">
							<h1>Рузультат теста</h1>
							Ваш результат: <b id="sum_result"></b> баллов<br/><br/>
...
<style scoped>
	h1{font-family:Tahoma !important;font-size:1.5rem;font-weight:bold;}
	#show_answer{display:none;}
	.modal-dialog{max-width:1000px;}
	.quest_area {padding:5px 0 15px 0;}
	#gotest {padding:20px;font-size:12pt;font-family:Tahoma;}
	.zagolovok {padding:10px;font-size:18pt;font-weight:normal;}
	.opisanie {padding:10px}
	#show_result {font-family:'Georgia',serif;color:#fff;border-radius:5px;padding:5px 10px;border:0;background-color:#f2354b;}
</style>
